...
int main(void){
	...
	*/
	...
	ovrvision.SetCameraExposure(6000);
			...
			*/
			if (left_right_mapper.size() != 0){
				...
				*/
				...
				cv::Affine3f out3f = viz_class.find_affine_transformation_3d(output_reordered, tumour_3d_pos);
				viz_class.render_point_cloud(output_reordered, out3f, "tumour_pos", 50.0f);
